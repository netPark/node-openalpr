var nativeBio = {},
  ...
  nativeLPR = fs.existsSync(native_lib_path) ? require(native_lib_path) : require(path.join(__dirname, "../release/" + process.platform + "_" + process.arch + "/node_openalpr.node"));
